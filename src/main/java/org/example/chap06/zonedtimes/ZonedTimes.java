package org.example.chap06.zonedtimes;

import java.time.*;

public class ZonedTimes {
    public static void main(String[] args) {
        ZonedDateTime appllo11launch = ZonedDateTime.of(1969,7,16,9,32,0,0,
                ZoneId.of("America/New_York"));
        System.out.println("appllo11launch: " + appllo11launch);

        Instant instant = appllo11launch.toInstant();
